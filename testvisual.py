...
layout = [[sg.Text('Begin Visualizing Processing Results (turn fancy numbers [.json] into red squares on camera trap images)')],
...
event, visualization = sg.Window('Window Title', layout).read(close=True)
